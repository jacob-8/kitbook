  ...
  <SplitPane min={0} pos={15}>
    ...
    <svelte:fragment slot="b">
      <SplitPane pos={75} min={20} max={100}>
        <section class="kb-1l52p7" slot="a">
          <slot />
        </section>
        <section class="kb-cjzbcu" slot="b">
          <InstrumentPanel />
        </section>
      </SplitPane>
    </svelte:fragment>
