export const testModules = {
    ...
    '/src/lib/A.svelte': () => Promise.resolve(null),
    '/src/lib/B.svelte': () => Promise.resolve(null),
    '/src/lib/B.svx': () => Promise.resolve(null),
    '/src/lib/a/C.svelte': () => Promise.resolve(null),
    '/src/lib/a/C.variants.ts': () => Promise.resolve(null),
    '/src/lib/a/D.svelte': () => Promise.resolve(null),
    '/src/lib/a/D.svx': () => Promise.resolve(null),
    '/src/lib/a/D.variants.ts': () => Promise.resolve(null),
    '/src/lib/E.svx': () => Promise.resolve(null),
    // pages
    '/src/routes/+page.svelte': () => Promise.resolve(null),
    '/src/routes/a/+page.svelte': () => Promise.resolve(null),
    '/src/routes/a/_page.svx': () => Promise.resolve(null),
    '/src/routes/b/+page.svelte': () => Promise.resolve(null),
    ...
    '/src/routes/a/+layout.svelte': () => Promise.resolve(null),
    '/src/routes/a/_layout.svx': () => Promise.resolve(null),
    '/src/routes/b/+layout.svelte': () => Promise.resolve(null),
    '/src/routes/b/_layout.variants.ts': () => Promise.resolve(null),
    '/src/routes/c/+layout.svelte': () => Promise.resolve(null),
