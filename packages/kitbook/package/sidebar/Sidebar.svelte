...
<ResponsiveSlideover showWidth="md" side="left" bind:open={showSidebar}>
  <div slot="mobileHeading" class="kb-lcew84">
    ...
    <button
      ...
      aria-label="Close"
    >
      <span class="kb-kvvl4l i-fa-solid-times" /></button
    >
  </div>
